package rioflashclient2.chrome.controlbar {
  ...
  import rioflashclient2.chrome.controlbar.widget.VideoFullScreenButton;
  ...
  public class ControlBar extends MovieClip {
    ...
    private function hasVideoFullScreenButton():Boolean {
      return hasButton('videoFullScreenButton');
    }
