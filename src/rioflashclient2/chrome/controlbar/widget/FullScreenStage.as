package rioflashclient2.chrome.controlbar.widget {
   ...
   * @author
   */
  public class FullScreenStage extends FullScreenButtonAsset{
    ...
    private function onClick(e:MouseEvent):void {
      if (currentState == fullScreenState) {
        EventBus.dispatch(new PlayerEvent(PlayerEvent.EXIT_FULL_SCREEN, "application"), EventBus.INPUT);
      } else {
        EventBus.dispatch(new PlayerEvent(PlayerEvent.ENTER_FULL_SCREEN, "application"), EventBus.INPUT);
      }
    }
